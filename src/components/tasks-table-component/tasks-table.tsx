            ...
            <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div className="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                    <div className="overflow-hidden">
                        <table className="min-w-full text-left text-sm font-light" data-testid="task-table">
                            <thead className="border-b font-medium dark:border-neutral-500" data-testid="task-table-head">
                            <tr data-testid="task-table-head-row">
                            ...
                            <tbody data-testid="task-table-body">
                            {
                                tasks.map((task: TaskDTO, index: number) => {
                                    return(<tr id={task.id} key={task.id} data-test-id={`task-table-row-${index}`} className="border-b dark:border-neutral-500" data-testid="task-table-body-row">
